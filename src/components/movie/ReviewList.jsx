        ...
        {reviews.map(review => (
          ...
          >
            {editedReview && editedReview.id === review.id ? (
              <div>
                <select
                  className='w-full bg-slate-800 p-3 border border-slate-700 rounded-lg focus:border-blue-500 focus:outline-none mb-3'
                  value={editType}
                ...
                <textarea
                  className='w-full bg-slate-800 border rounded-lg p-4 border-slate-700 focus:border-blue-500 focus:outline-none h-24 mb-3 resize-none'
                  value={editCommment}
                  onChange={e => setEditComment(e.target.value)}
                ></textarea>

                <button
                  className='bg-blue-600 px-6 py-2 rounded-lg hover:bg-blue-700 font-semibold mr-2'
                  onClick={handleSave}
                >
                  Save
                </button>
                ...
                <button
                  className='bg-slate-700 px-6 py-2 rounded-lg font-semibold hover:bg-slate-600'
